...
//		Dr.Frye
//		Due Date:5/3/2013
//		URL:http://unixweb.kutztown.edu/~tturn265/Searched.php
//		About:Displayes the products a user searched for-->
<HTML>
	<head>
		<title> login </title>
		...
		<div id="container" style="width:100%;height:100%;">
			...
			<?php
			   $connection;
				...
				//displays the data if it was a keyword
				else
				{
					for ($i = 0; $i < $num; $i++)
					{
